const content = {
    ru: {
        ...
        bioContent: `<p>Привет! Меня зовут Павел. Я QA engineer с четырехлетним опытом работы в мобильной игровой индустрии.</p>
                     <p>В последние годы я работал в студиях Stereo 7, Deus Craft и Playphoria, где приобрел опыт работы с Git, Unity, и автоматизацией тестирования. Моя работа заключалась не только в обнаружении багов, но и в создании качественных игровых продуктов в жанрах hyper/hybrid casual/tower defense.</p>
